...
export const createTokens = <BaseType = number, NaNType = 'NaN'>(mexp: Mexp<BaseType, NaNType>) => {
	var rawTokens: RawToken[] = [
		...
		{ token: 'int', show: 'Int', type: 0, value: mexp.math.floor },
		{ token: 'cosh', show: 'cosh', type: 0, value: mexp.math.cosh },
		{ token: 'acosh', show: 'acosh', type: 0, value: mexp.math.acosh },
		{ token: 'ln', show: ' ln', type: 0, value: mexp.math.log },
		{ token: '^', show: '^', type: 10, value: mexp.math.pow },
		{ token: 'root', show: 'root', type: 0, value: mexp.math.sqrt },
		...
		{ token: 'pow', show: 'pow', type: 8, value: mexp.math.pow, numberOfArguments: 2 },
